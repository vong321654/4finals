...
export default function FormValidation() {
    ...
    const onSubmitForm = (event) => {
        ...
        for(let f of inputFile.current.files) {
            if (f.size > maxSize * 1000) {
                alert(`ขนาดของแต่ละไฟล์ต้องไม่เกิน ${maxSize} KB/ไฟล์`)
    ...
    return (
        <div className="mt-3 mx-auto p-3 rounded" style={{ width:'400px', background:'#cee' }}>
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className="form-group mb-3">
                    ...
                    <input type="text" id="name" maxLength="50" className="form-control form-control-sm" 
                    {...register('name', {required: true, maxLength:30})}/>
                    {errors.name && <div style={err}>กรุณาระบุชื่อสินค้า</div>}
                </div>
                <div className="form-group mb-3">
                    <label htmlFor="price">ราคาสินค้า *</label>
                    <input type="number" id="price" name="price" min="0" step="any" className="form-control form-control-sm"
                ...
                <div className="form-group mb-3">
                    ...
                    <textarea id="detail" name="detail" rows="2" maxLength="250" className="form-control form-control-sm"
                ...
                <div className="form-group mb-3">
                    <label htmlFor="file">ภาพสินค้า * (ไม่เกิน 3 ไฟล์ ขนาดสูงสุด 300 KB/ไฟล์)</label>
                    ...
                    opts.map((opt, i) => {
                        return (
                            <div className="form-check form-check-inline mb-3">
                                <input type="checkbox" id={'opt'+i} value={opt} className="form-check-input"/>
